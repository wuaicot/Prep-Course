...
function esPrimo(numero) {
  ...
  // Itera desde el número 2 hasta la mitad del número
  for (let i = 2; i <= numero / 2; i++) {
    // Si el número es divisible por el número del bucle, entonces no es primo
    if (numero % i === 0) {
      return false;
    }
  }

  // Si el bucle termina sin encontrar ningún número que el número sea divisible, entonces el número es primo
  return true;
}
